...
TEST(StarterTrieTest, InsertTest2) {
  {
    {
      Trie trie;
      bool success = trie.Insert<std::string>("abc", "d");
      EXPECT_EQ(success, true);
      EXPECT_EQ(trie.GetValue<std::string>("abc", &success), "d");
    }

    {
      Trie trie;
      bool success = trie.Insert<std::string>("", "d");
      EXPECT_EQ(success, false);
      trie.GetValue<std::string>("", &success);
      EXPECT_EQ(success, false);
    }
...

    {
      ...
      EXPECT_EQ(trie.GetValue<int>("abc", &success), 5);
      EXPECT_EQ(success, true);
      EXPECT_EQ(trie.GetValue<int>("ab", &success), 6);
      EXPECT_EQ(success, true);
